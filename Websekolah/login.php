...
<body background="gambar/walpaper.jpeg">

    <div class="container">
        <div class="row mt-8">
            <div class="col-12">
                <div style="box-shadow: 1px 2px 8px rgba(0, 0, 0, 0.65);border-radius: 15px; height: 300px;margin: 12rem auto 8.1rem auto;width: 329px; background-color: darkseagreen;" class="card card-body">
